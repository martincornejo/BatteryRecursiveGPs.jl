...
if export_figs
    save("yuasa/figs/dataset-modules.pdf", fig_dataset)
    save("yuasa/figs/dataset-modules-overlay.pdf", fig_module_data)
    save("yuasa/figs/dataset-cell-voltages.pdf", fig_cell_voltages)
    save("yuasa/figs/dataset-resolution.pdf", fig_data_resolution)
    save("yuasa/figs/ecms.pdf", fig_ecms)
    save("yuasa/figs/ecm-parameters.pdf", fig_ecm_params)
    save("yuasa/figs/model-voltage-accuracy.pdf", fig_v_overview)
    save("yuasa/figs/cell-soh.pdf", fig_cell_soh)
    save("yuasa/figs/module-soh.pdf", fig_module_soh)
    save("yuasa/figs/cell-soh-hist.pdf", fig_cell_soh_hist)
    save("yuasa/figs/soc-ekf-diagnostic.pdf", fig_soc_diag)
    save("yuasa/figs/ekf-charge-error.pdf", fig_charge_error)
    save("yuasa/figs/soc-error.pdf", fig_soc_overview)
    save("yuasa/figs/soc-discrepancy-heatmap.pdf", fig_soc_heatmap)
end
